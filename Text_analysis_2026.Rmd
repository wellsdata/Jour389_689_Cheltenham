...
#Get rid of 27 (about police brutality), would detain boys in the jail before heading to Cheltenham,29, 40, 62,65 and 67 may be repeats, 69, 71 marks abuse but not beating, 
wrapped_text <- strwrap(as.character(afro_sun$clean_text[74]), width = 60)
writeLines(wrapped_text, "temp_text.txt")
file.edit("temp_text.txt")
